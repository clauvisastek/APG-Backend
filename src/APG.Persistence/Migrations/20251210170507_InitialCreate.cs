...
namespace APG.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "GlobalSalarySettings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployerChargesRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    IndirectAnnualCosts = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    BillableHoursPerYear = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GlobalSalarySettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultTargetMarginPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    DefaultMinimumMarginPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    DiscountPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    ForcedVacationDaysPerYear = table.Column<int>(type: "int", nullable: true),
                    TargetHourlyRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "ClientMarginSettings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientId = table.Column<int>(type: "int", nullable: false),
                    TargetMarginPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    TargetHourlyRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientMarginSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientMarginSettings_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientMarginSettings_ClientId",
                table: "ClientMarginSettings",
                column: "ClientId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GlobalSalarySettings_IsActive",
                table: "GlobalSalarySettings",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_GlobalSalarySettings_IsDeleted",
                table: "GlobalSalarySettings",
                column: "IsDeleted");
